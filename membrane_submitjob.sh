...
singularity exec --nv -B /work/users/{o}/{n}/{onyen} -B /proj $SIMG_PATH/$SIMG_NAME bash -c "cd $DATA_PATH; python ./Segment_Images.py $2 $1 '/proj/telston_lab/projects/keras_unet_models/membrane/keras_unet_model_transfer_cell_segmenter_06302023_1024x1024imagesize_model_config.json' '/proj/telston_lab/projects/keras_unet_models/membrane/keras_unet_model_transfer_cell_segmenter_06302023_1024x1024imagesize_weights_only.h5' 'membrane' 1001 1001"
